...
const INTERMEDIATECLASS_TABLE = 'intermediateClass';

const intermediateCourseSchema ={
  id:{
    allowNull: false,
    autoIncrement: true,
    primaryKey: true,
...
class IntermediateCourse extends Model{
  ...
  static config(sequelize){
    return {
      sequelize,
      tableName: INTERMEDIATECLASS_TABLE,
      modelName: 'IntermediateCourse',
      timestamps: false,
    }
  }
}

module.exports ={ INTERMEDIATECLASS_TABLE, intermediateCourseSchema, IntermediateCourse};
