...
const createAdvanceClassSchema = Joi.object({
...
const updateAdvanceClassSchema = Joi.object({
  id,
  course,
  section,
  chapter,
...
const getAdvanceClassSchema = Joi.object({
  id: id.required(),
});

const queryAdvanceClassSchema = Joi.object({
  limit,
  offset,
});

module.exports = { getAdvanceClassSchema, updateAdvanceClassSchema, createAdvanceClassSchema, queryAdvanceClassSchema };
